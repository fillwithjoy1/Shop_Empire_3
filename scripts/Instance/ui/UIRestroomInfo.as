package Instance.ui
{
   ...
   public class UIRestroomInfo extends UI_InfoDialog
   {
      ...
      public var femaleIcon:MovieClip;
      ...
      public function UIRestroomInfo()
      {
         super();
      ...
      override protected function Initialize(param1:Event) : void
      {
         ...
         if(_relation != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               _loc3_ = _relation.world.restRoomList.indexOf(_relation);
               if(_loc3_ in _relation.world.restRoomList)
               {
      ...
      function checkCapacity(param1:*) : void
      {
         ...
         if(param1 is FacilityRestRoom)
         {
            ...
            this.numberFemale.x = Math.round(this.capacityIcon.x - 20 - this.numberFemale.width);
            this.femaleIcon.x = Math.round(this.numberFemale.x + this.numberFemale.width - this.numberFemale.textWidth) - 12;
         }
      }

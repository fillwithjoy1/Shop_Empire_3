package greensock.plugins
{
   ...
   public class ShortRotationPlugin extends TweenPlugin
   {
      ...
      override public function onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         {
            this.initRotation(param1,_loc4_,param1[_loc4_],typeof param2[_loc4_] == "number" ? Number(Number(param2[_loc4_])) : Number(param1[_loc4_] + Number(param2[_loc4_])));
         }
         return true;
      }
      ...
      public function initRotation(param1:Object, param2:String, param3:Number, param4:Number) : void
      {
         ...
         {
            _loc5_ = _loc5_ < 0 ? Number(_loc5_ + 360) : Number(_loc5_ - 360);
         }
